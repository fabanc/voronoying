...
def validate_spatial_ref(inpoints, inlines):
...
def validate_topology(inpoints: str, inlines: str, factor: int, out_gdb: str):
    ...
    try:
        ...
        validate_spatial_ref(inpoints, inlines)
        ...
        # dataset requires this resolution and tolerance
        spatial_reference.XYResolution = 1 / (factor * 10)
        spatial_reference.XYTolerance = 1 / factor

        arcpy.management.CreateFeatureDataset(arcpy.env.workspace, "dataset", spatial_reference)
